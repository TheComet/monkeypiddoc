...
%\]
\begin{center}
Übertragungsfunktion PI-Regler (Reglerkonform) siehe Formel \eqref{eq:PITransmit}

%\[
%\text{Übertragungsfunktion PI-Regler (Bodekonform)}~Gr=Kr\cdot 
%\frac{1+s\cdot Tn}{s\cdot Tn}
%\]
Übertragungsfunktion PI-Regler (Bodekonform) siehe Formel \eqref{eq:PITransmitBode}
\end{center}
...
%\]
Übertragungsfunktion PID-Regler (Reglerkonform) siehe Formel \eqref{eq:PIDTransmit}
...
%Tp)} \right]
%\]
Übertragungsfunktion PID-Regler (Bodekonform) siehe Formel \eqref{eq:PIDTransmitBode}
\end{center}
