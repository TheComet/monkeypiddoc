...
Das Java-Tool wurde jeweils nach einer Implementation eines Elementes und durch die Teammitglieder getestet. Neben gewöhnlichen Eingaben wurde versucht, die Eingabefelder mittels Sonderzeichen und speziellen Werten zu überlisten. Die Resultierenden Erkenntnisse flossen anschliessend in die Endversion des Java-Tools mit ein. 
...
Ein Nachteil der IFFT Methode ist, dass ihre Komplexität $\mathcal{O}(n\log{}n)$ skaliert. Die Partialbruchzerlegungsmethode hingegen skaliert nur linear mit $\mathcal{O}(n)$. Dies ist gut ersichtlich, wenn man Figur \ref{fig:ifft_vs_pbz_2048} und \ref{fig:ifft_vs_pbz_8192} vergleicht.
