...
Mithilfe dieser Werte und der Sani Methode, welche vom Auftraggeber in Form eines Matlab-Files zur Verfügung gestellt wurde, ist es nun möglich, die Ordnung der Strecke sowie die Zeitkonstanten $T1$ bis $T_m$ zu berechnen, wobei $m$ die Ordnung der Strecke ist. Diese Zeitkonstanten werden dazu verwendet, die Übertragungsfunktion $H(s)$ zu berechnen:
