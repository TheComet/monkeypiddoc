...
Diese Faustformeln wurden gewählt, weil sie ebenfalls die Werte $Ks$, $Tu$ und $Tg$ verwenden, welche mittels Wendetangenten aus der Schrittantwort der Regelstrecke herausgelesen werden können.

Zur Verifizierung der Faustformeln wurden verschiedene Quellen verglichen und die in der Mehrzahl vorkommenden Werte wurden als richtig angesehen. %Quellenindex hinzufügen [3] [4] in Pflichtenheft
