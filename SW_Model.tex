...
interpoliert, um eine höhere Auflösung zu ermöglichen. Das Interpolieren erfolgt mittels der \textit{SplineNAK}-Klasse, welche von C in Java übersetzt wurde. \cite{CQuellCode}\\
