...
Immer wenn sich das \textit{Plant}-Objekt oder das \textit{AbstractController}-Objekt ändern, sei es durch eine Instanzierung oder durch Aufrufen der Methode \em{ClosedLoop::setPlantAndController()}, wird aus den beiden Übertragungsfunktionen des \textit{Plant}-Objektes und des \textit{AbstractController}-Objektes die Übertragungsfunktion des geschlossenen Regelkreises berechnet.
