...
\newpage
Im nächsten Schritt berechnet man mithilfe von $Tn$ und mit $Kr=1$ den offenen Regelkreis (rot dargestellt in Abbildung \ref{fig:PIStep2}).
...
Auf dem Phasengang des offenen Regelkreises (Abbildung \ref{fig:PIStep3}) wird nun die Frequenz bei $\phi_{Strecke}$ mithilfe der Tabelle \ref{table:TabÜberschwingen} auf Seite \pageref{table:TabÜberschwingen} gesucht (rot gestrichelte Linie). Die gefundene Frequenz ist $0.0611s^{-1}$.
...
\newpage
Schliesslich wird die entsprechende Verstärkung zur gefundenen Frequenz aus dem Amplitudengang des offenen Regelkreises herausgelesen (Abbildung \ref{fig:PIStep4}). In unserem Beispiel ergibt dies eine Verstärkung von 1.0390.  Um diesen Faktor wird die Verstärkung des Reglers gemindert, dies ergibt den letzten benötigten Parameter $Kr$.
