...
Auf dem offenen Regelkreis (Abbildung \ref{fig:PIStep3}) wird nun die Frequenz bei $\phi_{st}$ mithilfe der Tabelle \ref{table:TabÜberschwingen} auf Seite \pageref{table:TabÜberschwingen} gesucht (rot gestrichelte Linie). Die gefundene Frequenz ist $0.0611s^{-1}$.
